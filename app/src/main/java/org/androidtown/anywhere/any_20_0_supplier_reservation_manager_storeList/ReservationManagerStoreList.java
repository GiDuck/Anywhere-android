...
public class ReservationManagerStoreList extends Header {
    ...
    private ReservationManagerStoreListAdapter Adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setData();
        setContentView(R.layout.anywhere20_0_reservation_manager_storelist);

        initialize();
        setHeader();
        Adapter = new ReservationManagerStoreListAdapter(this);
    ...
    public void setData() {
        ...
        /*nick*/
            ...
            e.printStackTrace();
            Intent intent = new Intent(ReservationManagerStoreList.this, SupplierMain.class);
